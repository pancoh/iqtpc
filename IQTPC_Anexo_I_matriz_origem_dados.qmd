...
**Finalidade:** descer ao nível da variável, que é o nível em que o cálculo acontece ou não acontece. O documento principal (seção 11) resume a fonte por subíndice; o Manual (seção 10) classifica cada métrica por origem predominante; este anexo rastreia cada variável e classifica a viabilidade de cada métrica
